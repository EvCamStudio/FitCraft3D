      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-6 sm:pt-8 pb-10 sm:pb-16" ref={sectionRef}>
        ...
        >
          ...
          <div className="relative min-h-[360px] sm:min-h-[450px] lg:min-h-[550px] flex items-center justify-center bg-gradient-to-b from-[#0c0f12] to-[#08090a]">
            ...
            <div className="w-full h-[360px] sm:h-[450px] lg:h-[550px] relative flex items-center justify-center">
              {/* Radial backglow to separate black model from dark background */}
              <div className="absolute w-[280px] sm:w-[400px] h-[280px] sm:h-[400px] bg-[radial-gradient(circle,rgba(255,255,255,0.06)_0%,rgba(45,226,149,0.03)_50%,rgba(0,0,0,0)_100%)] rounded-full blur-[60px] sm:blur-[80px] pointer-events-none z-0" />
          ...
          <div className="absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 z-20">
            <button
              onClick={() => onNavigate('studio', activeProduct.id, selectedColor.hex)}
