  ...
  return (
    <div ref={containerRef} className="landing-page-wrapper">
      ...
      <section className="features-section snap-section" id="features">
        ...
        <div className="bg-parallax-text" aria-hidden="true" style={{ '--parallax-speed': '-0.15', top: '5%', left: '-5%' }}>FITCRAFT</div>
        <div className="bg-parallax-text outline" aria-hidden="true" style={{ '--parallax-speed': '0.1', top: '50%', left: '15%' }}>PREMIUM</div>
      ...
      {/* FEATURE SPOTLIGHT: DRAG & DROP EDITOR */}
      <section className="spotlight-section snap-section" id="editor-spotlight" style={{ position: 'relative', overflow: 'hidden' }}>
        {/* Parallax Background Elements */}
        <div className="bg-parallax-text outline" aria-hidden="true" style={{ '--parallax-speed': '-0.06', top: '25%', right: '-5%', left: 'auto' }}>EDITOR</div>

        <div className="section-container spotlight-container">
          {/* Left Column: Copy & Checklist */}
          <div className="spotlight-content">
            <span className="section-eyebrow">TEKNOLOGI EDITOR 3D</span>
            <h2 className="spotlight-title">
              Desain Keren, Semudah <br />
              <span className="accent">Drag &amp; Drop 3D</span>
            </h2>
            <p className="spotlight-desc">
              Tidak perlu keahlian desain tingkat tinggi. Seluruh kontrol stiker, logo brand, teks kustom, dan pilihan bahan premium dapat Anda atur secara instan langsung pada model pakaian 3D.
            </p>
            ...
            <ul className="spotlight-checklist">
              <li className="checklist-item">
                ...
                <div className="checklist-text">
                  <strong>Presisi Decal Snapping</strong>
                  <span>Logo otomatis menempel pas mengikuti kelengkungan serat kain baju secara real-time.</span>
                </div>
              </li>
              <li className="checklist-item">
                <div className="check-icon-wrapper">
                ...
                <div className="checklist-text">
                  <strong>Text Styling Kustom</strong>
                  <span>Ketik teks kustom, pilih font modern, dan atur warna kontras yang dinamis.</span>
                </div>
              </li>
              <li className="checklist-item">
                <div className="check-icon-wrapper">
                ...
                <div className="checklist-text">
                  <strong>Simulasi Ukuran 3D</strong>
                  <span>Ubah ukuran pakaian dari S hingga XXL dengan transisi skala 3D yang sangat halus.</span>
                </div>
              </li>
            </ul>
          </div>

          {/* Right Column: Visual Showcase representing 3D drag-and-drop */}
          <div className="spotlight-visual">
            <div className="visual-canvas-mockup">
              <div className="canvas-header">
                ...
                <span className="canvas-title">3D Decal Editor Viewport</span>
              </div>
              <div className="canvas-body">
                {/* Dotted Blueprint Grid */}
                <div className="blueprint-grid"></div>

                {/* Image Garment Mockup representing Kaos */}
                <div className="garment-mockup-wrapper">
                  <img src="./assets/models/product-2.webp" alt="Kaos Kustom" className="garment-img garment-svg" />

                  {/* Decal with editor bounding box representing a Skull Logo */}
                  <div className="interactive-decal-box">
                    <div className="decal-logo-graphic">
                      {/* Skull SVG */}
                      <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="currentColor" strokeWidth="1.5" className="skull-svg">
                        <path d="M12 2C6.48 2 2 6.48 2 12c0 3.75 2.07 7.03 5.15 8.78.29.17.65-.03.65-.37V18c0-.55.45-1 1-1h1.5c.55 0 1-.45 1-1v-1.5c0-.55-.45-1-1-1H9c-1.1 0-2-.9-2-2v-1.5c0-.55.45-1 1-1h6.5c.55 0 1 .45 1 1V11c0 1.1-.9 2-2 2h-1.5c-.55 0-1 .45-1 1v1.5c0 .55.45 1 1 1H15c.55 0 1 .45 1 1v2.41c0 .34.36.54.65.37C19.93 19.03 22 15.75 22 12c0-5.52-4.48-10-10-10z" strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    {/* Designer Bounding Box Handles */}
                    <div className="decal-border-outline"></div>
                    ...
                    <div className="decal-info-badge">Decal: 48x48px (X: 0.12, Y: 0.45)</div>
                  </div>

                  {/* Animated Editor Cursor dragging the decal */}
                  <div className="interactive-cursor">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                      <path d="M4.5 3v15.25l4.57-4.57 3.32 7.73 2.92-1.25-3.32-7.73h6.01L4.5 3z" />
                    </svg>
                    <span className="cursor-pulse"></span>
                  </div>
                </div>

                {/* Floating Editor Controls on the side */}
                <div className="floating-editor-controls">
                  <div className="control-slider-group">
                    <label>Scale</label>
                    <div className="control-slider-track">
                      <div className="control-slider-thumb" style={{ left: '60%' }}></div>
                    </div>
                  </div>
                  <div className="control-slider-group">
                    <label>Opacity</label>
                    <div className="control-slider-track">
                      <div className="control-slider-thumb" style={{ left: '85%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="step-card-header">
                <div className="step-icon-container">
                  <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M20.38 3.46L16 7.83l-1-1 4.38-4.37a1 1 0 1 1 1 1z" />
                    <path d="M18.5 12.5a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" />
                    <path d="M12 2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
