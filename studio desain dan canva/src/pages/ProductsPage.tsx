...
const products = [
  ...
  },
  {
    ...
    image: '/assets/showcase-jersey.png',
    price: 199000,
  },
  {
    id: 'sweater' as const,
    ...
    image: '/assets/showcase-sweater.png',
    price: 299000,
  },
];
...
export default function ProductsPage({ onNavigate }: ProductsPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#08090a] relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#2de295]/8 rounded-full blur-[150px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <button
              ...
              className="flex items-center gap-2 text-sm text-[#9ba3af] hover:text-[#2de295] transition-colors"
            >
          ...
          <div className="flex items-center gap-4">
            <button className="relative text-[#9ba3af] hover:text-[#2de295] transition-colors">
        ...
        >
          ...
          <div className="relative min-h-[500px] lg:min-h-[550px] flex items-center justify-center bg-gradient-to-b from-[#0c0f12] to-[#08090a]">
            ...
            >
              <img
                ...
                className="w-72 lg:w-80 drop-shadow-[0_0_80px_rgba(45,226,149,0.15)] animate-float"
              />
            ...
            <div className="absolute bottom-8 left-8 z-20 max-w-xs">
              ...
              <h2 className="font-[var(--font-display)] font-bold text-3xl lg:text-4xl leading-tight mb-3">
            ...
            <div className="absolute bottom-8 right-8 z-20 flex gap-3">
              <button
                onClick={prevProduct}
                className="w-12 h-12 rounded-full glass-panel flex items-center justify-center hover:border-[#2de295]/50 transition-all group"
              >
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20">
            <button
              ...
              className="btn-primary shadow-[0_0_40px_rgba(45,226,149,0.3)]"
            >
              Desain Sekarang
